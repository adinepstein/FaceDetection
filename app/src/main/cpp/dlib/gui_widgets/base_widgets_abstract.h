...
// ----------------------------------------------------------------------------------------
    ...
    class menu_item_separator : public menu_item
    {
        /*!
            WHAT THIS OBJECT REPRESENTS
                This object is a horizontal separator in a popupDialog menu
        !*/
    };
...
// ----------------------------------------------------------------------------------------
    ...
    class popup_menu : public base_window
    {
        /*!
            ...
            WHAT THIS OBJECT REPRESENTS
                This object represents a popupDialog menu window capable of containing
                menu_item objects.
        !*/
    ...
    public:
        ...
        /*!
            ensures
                - causes this popupDialog menu to highlight the first
        ...
        /*!
            ...
            ensures
                - forwards this keyboard event to this popupDialog window so that it
...
// ----------------------------------------------------------------------------------------
    ...
    class popup_menu_region : public drawable 
    {
        /*!
            ...
            WHAT THIS OBJECT REPRESENTS
                ...
                provides a region the user can click on to get a popupDialog menu.
        !*/
    ...
    public:
        ...
        /*!
            ensures
                - if (the popupDialog menu is currently visible on the screen) then
                    - returns true
                - else
                    - returns false
        !*/
